...
const COLOR_HOME_ENTRY_INDEX = {
  blue:   (0 + 50) % 52,   // = 50 → pos 50 = [7,14] → home col goes UP col=7
  red:    (13 + 50) % 52,  // = 11 → pos 11 = [0,7]  → home col goes RIGHT row=7
...
const HOME_COL_ENTRY = {
  blue:   [7,14],   // position 50 on main path
  red:    [0,7],    // position 11 on main path
